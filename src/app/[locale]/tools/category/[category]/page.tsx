...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; category: string }> }) {
    ...
    return generateBaseMetadata({
        ...
        description: `Free online ${formattedCategory} PDF tools. Secure, private, browser-based utilities for working with PDF files.`,
        keywords: [formattedCategory, `${formattedCategory} PDF tools`, 'PDF tools category'],
    });
}
