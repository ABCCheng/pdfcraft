...
export const locales = ['en', 'zh-Hans', 'zh-Hant', 'fr', 'es', 'de', 'it', 'pt', 'ja', 'ko'] as const;
...
export const localeConfig: Record<Locale, {
  ...
  'zh-Hans': { name: 'Chinese (Simplified)', nativeName: '简体中文', direction: 'ltr', dateFormat: 'YYYY-MM-DD' },
  'zh-Hant': { name: 'Chinese (Traditional)', nativeName: '繁體中文', direction: 'ltr', dateFormat: 'YYYY/MM/DD' },
...
export function getLocalizedPath(path: string, locale: Locale): string {
  const cleanPath = path.replace(/^\/(en|zh-Hans|zh-Hant|fr|es|de|it|pt|ja|ko)(\/|$)/, '/');
